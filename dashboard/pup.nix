...
let
  ...
  spvnode_bin = pkgs.callPackage (pkgs.fetchurl {
    url = "https://raw.githubusercontent.com/edtubbs/dogebox-nur-packages/b7c96c478fef4d4bed2dd61dfc41ff685f4e4e6f/pkgs/libdogecoin/default.nix";
    sha256 = "sha256-j2jefSqOqVp8ImjClALU2jeBBDjG/ZDdJzwx3kvY4fE=";
  }) {
  };
  ...
  spvnode = pkgs.writeScriptBin "run.sh" ''
    ...
    # Run spvnode with the addresses, from a checkpoint and header-only until sync
