...
let
  ...
  spvnode_bin = pkgs.callPackage (pkgs.fetchurl {
    url = "https://raw.githubusercontent.com/edtubbs/dogebox-nur-packages/5e496c205e97d6ec0a6d07ba5df4230b42790599/pkgs/libdogecoin/default.nix";
    sha256 = "sha256-Tztm+x7g94WYy5zSRo3BU3HYnmteLvPszxyLU4/q4Tk=";
  }) {
  };
